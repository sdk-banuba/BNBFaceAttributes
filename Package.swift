...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-183-gf9e3d7354f/BNBFaceAttributes.zip",
            checksum: "4619dc47c88dad867e031046b209d5ca37979632b2a0e789aba98733cc6fe600"
        ),
        .target(

...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-186-g71865c20be/BNBFaceAttributes.zip",
            checksum: "4db8902b7d4c6d19c6d0cc500422e6c4c0593500ae8aea053ca2ad9b87899a91"
        ),
        .target(

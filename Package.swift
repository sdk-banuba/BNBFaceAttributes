...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-178-g3b9a032012/BNBFaceAttributes.zip",
            checksum: "292465af7c6d4d0c01de88662e621455b106bb1bd6f861caf20bc0b2e60c288e"
        ),
        .target(

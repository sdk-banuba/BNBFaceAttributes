...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-194-gb1629e3e8c/BNBFaceAttributes.zip",
            checksum: "e3d0780f47d0d97df60d96d74c5a6b05bfca91e3175b416f37abb04c9e6d4838"
        ),
        .target(

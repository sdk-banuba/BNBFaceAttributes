...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-217-g36d3a95c51/BNBFaceAttributes.zip",
            checksum: "f448b6c8839644bd45a1d77493e141905852130178b5cbfd03baecc93bdbd62b"
        ),
        .target(

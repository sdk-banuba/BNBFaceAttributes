...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-199-g2f4e3cf953/BNBFaceAttributes.zip",
            checksum: "25d28ae94198fc486ccefbe2a80b5c893539f4d6e3fe632e55b68a491dd670e6"
        ),
        .target(

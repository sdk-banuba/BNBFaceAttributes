...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-211-g9ce64ef1c2/BNBFaceAttributes.zip",
            checksum: "52872f72c0deaba90a5784442d57fc982ccc5d1a2656efd5faf411894df93563"
        ),
        .target(

...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-75-g381c51d93/BNBFaceAttributes.zip",
            checksum: "ac9a89e5cad50586d1c26b23c3e72b07c7b1957cebbce98dce3edaeb25a74418"
        ),
        .target(

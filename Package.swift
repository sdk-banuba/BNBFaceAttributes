...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-33-g6de24312a/BNBFaceAttributes.zip",
            checksum: "00be00c43f72fb732dcba07706f43cd82ea90d6f0dd03482fe9fbb7740ec2a73"
        ),
        .target(

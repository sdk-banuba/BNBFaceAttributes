...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-162-gcda6b9c4b/BNBFaceAttributes.zip",
            checksum: "9b4a5afada33d21ffd747273858b0c1646575be3636f914a9dc56ccef7978ccb"
        ),
        .target(

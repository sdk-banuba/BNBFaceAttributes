...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-204-g6de1b78ed5/BNBFaceAttributes.zip",
            checksum: "3c4b63ffb583e035e2c5f048c3e0035f175673e3f06419ddbb76c5888697aaf7"
        ),
        .target(

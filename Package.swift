...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.13.0-1-g971efc62f/BNBFaceAttributes.zip",
            checksum: "9a27e10167a81ae1dcb1d61d434b51b7265509e6f52c3ef54b8c61ddda12e11d"
        ),
        .target(

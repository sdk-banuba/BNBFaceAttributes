...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g91aac4bda/BNBFaceAttributes.zip",
            checksum: "90b75163313172a79cf5b5ac85de1b9311b147e5a1f9e56b261788708531fe69"
        ),
        .target(

...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-68-g8184560bc/BNBFaceAttributes.zip",
            checksum: "11f2bc30a0c72328339889fde3fc24ef7207a5c67ee1d7a76378aa7473720024"
        ),
        .target(

...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-177-gd98bf09f0/BNBFaceAttributes.zip",
            checksum: "a781ad17a207468044616035701e265b7ae0c9425ab4f736345416edd921d748"
        ),
        .target(

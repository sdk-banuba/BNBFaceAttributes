...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-105-gb559f9611/BNBFaceAttributes.zip",
            checksum: "31c76b4767a355f11fa8246d380f6ff700647cdceaeb7305daf4bd01cdbfc2f7"
        ),
        .target(

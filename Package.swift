...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.0-9-g9cd2ba648/BNBFaceAttributes.zip",
            checksum: "0e8e9f6470df34aedfa386b114a4c37a4a4bb0e9511e88a8d743004d5409285d"
        ),
        .target(

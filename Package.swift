...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-74-g9d1b0a47e/BNBFaceAttributes.zip",
            checksum: "94b158247b1160dc6812b06d91f390726a181f0f69cb9480529c3aa34acbbb7e"
        ),
        .target(

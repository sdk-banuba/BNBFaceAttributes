...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-136-g6ec65980f/BNBFaceAttributes.zip",
            checksum: "982c9b99c1ca96e93c238ebc7decff36c3368e1816d78878e048f464990b1299"
        ),
        .target(

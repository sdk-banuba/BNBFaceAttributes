...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.1-32-gc91d258b34/BNBFaceAttributes.zip",
            checksum: "b3a589560ccf1468ff7e7d81a1b94a98c96d639784b70446ed3438ad64946249"
        ),
        .target(

...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-70-g2e0f1ab74/BNBFaceAttributes.zip",
            checksum: "242c47f6e913e17261197578b83afc574efc27f609b1860740fadadc89993376"
        ),
        .target(

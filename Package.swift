...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-215-g9f21b13b23/BNBFaceAttributes.zip",
            checksum: "e59362608f6896353df3df1a7bc5385f5760b198ed76c9204d7c9362253a917e"
        ),
        .target(

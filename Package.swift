...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.18.2-24-g50ecbc89fd/BNBFaceAttributes.zip",
            checksum: "85be3c9bc90f00f80f96dabdad0b1b1cea811bad48a691228164dfd0db3f2959"
        ),
        .target(

...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-184-gd8cb662170/BNBFaceAttributes.zip",
            checksum: "2e87115153d7e3357637a21166da017360874a8adc812a9d4efef1b089edbc23"
        ),
        .target(

...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-106-g81956e5c7/BNBFaceAttributes.zip",
            checksum: "afb5193d875ad23e13db065b9f3d5e81a9ea0910be50548d1f91c2dca1d52726"
        ),
        .target(

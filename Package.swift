...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-71-g826381c83/BNBFaceAttributes.zip",
            checksum: "45422774424dfcef3ff6c159387734f0ef9bc8b48b680aa6886175e192778fbd"
        ),
        .target(

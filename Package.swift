...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-150-gd7caecfaf/BNBFaceAttributes.zip",
            checksum: "85cd494190035c76e20c0f24588dacb97ca1ff0ac89fda32a9de37bd89987ad8"
        ),
        .target(

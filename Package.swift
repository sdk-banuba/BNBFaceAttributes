...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-214-g5030d169c2/BNBFaceAttributes.zip",
            checksum: "dd2386dd3d6f4502088d6decb16c55419bd28e3c497886ea435b3b583f0b5a5c"
        ),
        .target(

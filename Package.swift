...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-178-gf86664003c/BNBFaceAttributes.zip",
            checksum: "064f175a15367482dde42f3b179b9b3845993d853deb486643ea06f2a7883bbd"
        ),
        .target(

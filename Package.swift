...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-67-g77a5e386d/BNBFaceAttributes.zip",
            checksum: "88b61d89cfc5c60b7a19ccc354b298540b47ed2cd9bf276ed7daa3a65d37ab06"
        ),
        .target(

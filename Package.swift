...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-147-gb1b24af02/BNBFaceAttributes.zip",
            checksum: "d3ddb3a0179214db2f782090b36a207f45185f816b768c7ff57c2eadad9b063a"
        ),
        .target(

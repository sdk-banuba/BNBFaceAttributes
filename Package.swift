...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-175-g35e1b614c0/BNBFaceAttributes.zip",
            checksum: "0a9ec33587548c53e786c0c2fdec8e993a0168b3727f8bb722d54881d74c61f0"
        ),
        .target(

...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.2-5-gf3828971b9/BNBFaceAttributes.zip",
            checksum: "8d5e18e88d3a44fd28e2a3e983d0fa3aac27366c09b0fef4ea6a761e78e43098"
        ),
        .target(

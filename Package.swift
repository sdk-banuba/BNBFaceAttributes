...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-124-gbdb47c5e3/BNBFaceAttributes.zip",
            checksum: "ec483e3edb5268f225135bcff8d4818e74635e411b6c19dff4423f6c013875e7"
        ),
        .target(

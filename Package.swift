...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-70-g9f1f1a3b1/BNBFaceAttributes.zip",
            checksum: "597bc45f8101fe74ca5e5ecdfeb07f01b52bf29618c8cf8ee39ef72ee756688f"
        ),
        .target(

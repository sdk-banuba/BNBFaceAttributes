...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-40-gb99e5d381/BNBFaceAttributes.zip",
            checksum: "fcd6e35681ab3649af4c82b17188cbf1fecbb75af8f5a1f59f17df721dcbf299"
        ),
        .target(

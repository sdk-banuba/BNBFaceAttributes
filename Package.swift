...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-173-gec24d1c86/BNBFaceAttributes.zip",
            checksum: "dda9485b0e5db1479c030b7671e92b99cec296c424a7024987cc6a4ef9d9c578"
        ),
        .target(

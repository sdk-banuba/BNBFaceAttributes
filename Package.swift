...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-271-g70b8136591/BNBFaceAttributes.zip",
            checksum: "c675dddf5e245f74affdaa94d80a0097ddbdd1ccbc76c9403207d61f39dc156d"
        ),
        .target(

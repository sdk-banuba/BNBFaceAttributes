...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-4-g0bf2ba10e/BNBFaceAttributes.zip",
            checksum: "ca637fea3589bf8f58742fa427d038c328c88d85c43b59d6c4dc679e7bd8a5f4"
        ),
        .target(

...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.18.0-8-g22fe376040/BNBFaceAttributes.zip",
            checksum: "7c56dbcb36bbcd1dfd402840e54a8f84600adbdcab87684bbe18370b7efe5d73"
        ),
        .target(

...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-185-gf41e807277/BNBFaceAttributes.zip",
            checksum: "d5f20d9bf7509873b0f4910e33153ea4dfdac4072144a9c7307aaea77bbbd274"
        ),
        .target(

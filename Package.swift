...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-137-gc11b2b754/BNBFaceAttributes.zip",
            checksum: "a2b70f4397b7e5c4576ed93df31a6e26b56c50ae6fe0442cf861ad0bb0e27529"
        ),
        .target(

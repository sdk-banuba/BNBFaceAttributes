...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-61-gc1c7cef54/BNBFaceAttributes.zip",
            checksum: "be7ec4a3fc88ba05fe608bcad15e12e93cf3fe9306fa850d1527fdb7195866b4"
        ),
        .target(

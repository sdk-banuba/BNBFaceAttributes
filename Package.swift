...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.15.1-1-g11945c35fb/BNBFaceAttributes.zip",
            checksum: "291ef530b90a25660e810cc99c33166efd6870cf7219d46738ecdbbe9a0ee623"
        ),
        .target(

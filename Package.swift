...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-53-g189d46433/BNBFaceAttributes.zip",
            checksum: "7f59f28bd60abdd45240458e55c74d9f099fb84cf1cd16845066a55cf10941bd"
        ),
        .target(

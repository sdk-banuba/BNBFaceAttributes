...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-162-g26e50cae8/BNBFaceAttributes.zip",
            checksum: "a2bd765f47776375e0c8640f96617879c74c1b740f044993271d811e3b9e2df0"
        ),
        .target(

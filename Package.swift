...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g93323bc96/BNBFaceAttributes.zip",
            checksum: "10625357e3910762da61492aed3b624a9dabdf18ec0a01db8442daff242970a4"
        ),
        .target(

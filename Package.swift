...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-211-g9b253c9f0f/BNBFaceAttributes.zip",
            checksum: "bf7b9110e5e3ae146409c710ad00c6cffba3e9aef1810567797e1111b31cbda7"
        ),
        .target(

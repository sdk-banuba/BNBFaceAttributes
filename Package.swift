...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.13.2-44-g649e5173b/BNBFaceAttributes.zip",
            checksum: "7bcb7e4a092714996751d907416ceb3db51ee1892318d8992cddc09990225ef4"
        ),
        .target(

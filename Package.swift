...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-216-gc859e59035/BNBFaceAttributes.zip",
            checksum: "661b900797e384ccf85013a8b42e29012fc1de6bac779cbddfc5ec1117ccf8a4"
        ),
        .target(

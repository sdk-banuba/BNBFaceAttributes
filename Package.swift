...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-55-g4d630007f/BNBFaceAttributes.zip",
            checksum: "e3d5d26467e17a3441759bf560aba11aee0dfc5a6ed88b222399b9334cf3152c"
        ),
        .target(

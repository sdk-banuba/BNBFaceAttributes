...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-185-gcf256de1ef/BNBFaceAttributes.zip",
            checksum: "5497821eb56208f771252dc9b244e88e359b6dbf2e56533510e11859d179bee9"
        ),
        .target(

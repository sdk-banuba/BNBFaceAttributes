...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-184-gfc3672a53b/BNBFaceAttributes.zip",
            checksum: "2b3ab60cafe9f8b524de28be3ec43e0f3aef23c012b138a82c1c229b1213f2f3"
        ),
        .target(

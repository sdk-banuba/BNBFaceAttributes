...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceAttributes",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-242-g622cf17fa4/BNBFaceAttributes.zip",
            checksum: "08e1dab2671ed7a223d3b740cb81263746c8fbf6cf436da7857ba56ca71a53b1"
        ),
        .target(
